...
export default function MultChoice({updateForm, form, id}) {
  ...
  return(
    <div>
      <form>
        ...
        <input id="multChoice" name="test" value="multChoice" type="radio" checked onChange={handleChange}/>
        <label>Multiple Choice</label><br></br>
        <input id="checkboxes" name="test" value="checkboxes" type="radio" onChange={handleChange}/>
